    ...
    <el-collapse v-model="activeName" accordion>
        ...
        <el-table
          ...
          <el-table-column prop="review" label="状态" width="100" align="center" :filters="options" :filter-method="filterHandler">
            <template slot-scope="scope">
              <span v-if="scope.row.review===1" style="color:#E6A23C">待审核</span>
      ...
      <el-collapse-item title="会议论文" name="2">
        <el-table
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="props">
              <el-button size="mini" type="primary" :disabled="props.row.review!=1" @click="handlePass(2, props.row.mpaperId, props.row.review)">通过</el-button>
              <el-button  size="mini" type="danger" :disabled="props.row.review!=1" @click="handleReject(2, props.row.mpaperId, props.row.review)">否决</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
      ...
      <el-collapse-item title="专利" name="3">
        <el-table
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="props">
             <el-button size="mini" type="primary" :disabled="props.row.review!=1" @click="handlePass(3, props.row.patentId, props.row.review)">通过</el-button>
              <el-button  size="mini" type="danger" :disabled="props.row.review!=1" @click="handleReject(3, props.row.patentId, props.row.review)">否决</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
      ...
      <el-collapse-item title="项目" name="4">
        <el-table
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="props">
              <el-button size="mini" type="primary" :disabled="props.row.review!=1" @click="handlePass(4, props.row.projectId, props.row.review)">通过</el-button>
              <el-button  size="mini" type="danger" :disabled="props.row.review!=1" @click="handleReject(4, props.row.projectId, props.row.review)">否决</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
      ...
      <el-collapse-item title="学术专著" name="5">
        <el-table
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="props">
              <el-button size="mini" type="primary" :disabled="props.row.review!=1" @click="handlePass(5, props.row.subjectId, props.row.review)">通过</el-button>
              <el-button  size="mini" type="danger" :disabled="props.row.review!=1" @click="handleReject(5, props.row.subjectId, props.row.review)">否决</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
      ...
      <el-collapse-item title="软件著作权" name="6">
        <el-table
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="props">
              <el-button size="mini" type="primary" :disabled="props.row.review!=1" @click="handlePass(6, props.row.softwareId, props.row.review)">通过</el-button>
              <el-button  size="mini" type="danger" :disabled="props.row.review!=1" @click="handleReject(6, props.row.softwareId, props.row.review)">否决</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
      ...
      <el-collapse-item title="公共事务" name="7">
        <el-table
          ...
          <el-table-column label="操作" align="center">
            <template slot-scope="props">
              <el-button size="mini" type="primary" :disabled="props.row.review!=1" @click="handlePass(1, props.row.mpaperId, props.row.review)">通过</el-button>
              <el-button  size="mini" type="danger" :disabled="props.row.review!=1" @click="handleReject(1, props.row.mpaperId, props.row.review)">否决</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
