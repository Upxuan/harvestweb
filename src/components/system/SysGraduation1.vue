            ...
            <el-col :span="24">
              <div class="col-md-12" v-for="(item, index) in fileList" :key="index">
                <div class="fileCard filelink">
                  <el-row>
                    <el-col :span="18">
                      <!-- <a :href="fileHref+'/'+fileList[index]" :download="fileList[index]" onclick="downloadFile(item)">{{ item }}</a> -->
          ...
          <template slot-scope="props">
            ...
            <el-upload
              ...
              <div slot="tip" class="el-upload__tip" style="color:#8C8C8C;">
                <el-alert title="注意：只能上传不超过1G的不重名文件" type="warning" show-icon style="height:30px;" :closable="false"></el-alert>
              </div>
            </el-upload>
          </template>
        </el-form-item>
